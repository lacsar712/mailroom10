...
import (
	...
	"example.com/mailroom/internal/backup"
	"example.com/mailroom/internal/model"
	"example.com/mailroom/internal/policy"
	"example.com/mailroom/internal/report"
	"example.com/mailroom/internal/validate"
	"example.com/mailroom/internal/workflow"
)
...
func (s *Server) handleBackup(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Disposition", "attachment; filename=mailroom.zip")
	_, _ = w.Write(b)
}
